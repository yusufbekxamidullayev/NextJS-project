...
const ShopCart = ({src , star , desc , price , discount , rating , not , dis}:{src:string , star:string , desc:string , price:string , discount:string , rating:string , not:string , dis:string}) => {
  return (
      <div><div>
