          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <button className="aspect-square rounded-xl overflow-hidden border-2 border-transparent hover:border-neutral-300 transition-all">
                <img src="https://images.unsplash.com/photo-1503342394128-c104d54dba01?w=200" alt="View 2" className="w-full h-full object-cover" />
              </button>
              <button className="aspect-square rounded-xl overflow-hidden border-2 border-transparent hover:border-neutral-300 transition-all">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <div className="flex gap-3">
                <button className="w-10 h-10 rounded-full ring-2 ring-offset-2 ring-neutral-900" style={{ backgroundColor: '#556B2F' }} />
                <button className="w-10 h-10 rounded-full hover:scale-105 transition-transform" style={{ backgroundColor: '#36454F' }} />
                <button className="w-10 h-10 rounded-full hover:scale-105 transition-transform" style={{ backgroundColor: '#1B263B' }} />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="flex gap-3">
                <button className="px-6 py-3 rounded-full font-medium bg-neutral-100 text-neutral-900 hover:bg-neutral-200 transition-colors">
                  Small
                </button>
                <button className="px-6 py-3 rounded-full font-medium bg-neutral-100 text-neutral-900 hover:bg-neutral-200 transition-colors">
                  Medium
                </button>
                <button className="px-6 py-3 rounded-full font-medium bg-neutral-900 text-white shadow-lg">
                  Large
                </button>
                <button className="px-6 py-3 rounded-full font-medium bg-neutral-100 text-neutral-900 hover:bg-neutral-200 transition-colors">
                  X-Large
            ...
            <div className="flex gap-4">
              <div className="flex items-center bg-neutral-100 rounded-full px-6 py-3">
                <button className="text-xl font-semibold hover:text-neutral-600 transition-colors px-2">−</button>
                <span className="mx-6 font-medium text-lg">1</span>
                <button className="text-xl font-semibold hover:text-neutral-600 transition-colors px-2">+</button>
              </div>

              <button className="flex-1 bg-neutral-900 text-white py-4 rounded-full font-semibold hover:bg-neutral-800 transition-all">
                Add to Cart
              </button>
            </div>
          </div>
